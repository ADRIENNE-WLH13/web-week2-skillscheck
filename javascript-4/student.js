...
let faveColors = ["purple", "yellow", "red"];
...
let me = {
    firstName: "Adrienne",
    superHeroName: "Amazing Adrienne",
    homeTown: "Salt Lake City",
    superPowers: ["skiing", "crime fighting", "kickboxing"],
...
const setColor = arr => {
    ...
    const colorArr = arr.map( ele => ele === 'blue' ? ele = '#4d4dff': ele)
    background(...colorArr)
  }
